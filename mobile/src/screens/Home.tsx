            ...
            <View className="flex-row mt-6 mb-2">
                {
                    weekDays.map(weekDay => (
                        <Text key={weekDay.dia} className="text-zinc-400 text-xl font-bold text-center mx-1"
                ...
                {summary ? <View className="flex-row flex-wrap">
                    {
                        datesFromYearStart.map(date => {
                            ...
                            return (
                                ...
                                date={date} amountOfHabit={dayHabits?.amount} amountCompleted={dayHabits?.completed}
